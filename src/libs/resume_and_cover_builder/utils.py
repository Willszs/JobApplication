...
def current_month_year(tz: str = "Europe/Berlin", lang: str = "en") -> str:
    """
    Return a string like 'October 2025' (en) or 'Oktober 2025' (de).
    """
    dt = datetime.now(ZoneInfo(tz)) if ZoneInfo else datetime.now()
    ...
    name = months_en[dt.month - 1] if lang == "en" else months_de[dt.month - 1]
